...
import Row from "~/assets/justified-layout/row.js";

/**
 * Create a new, empty row.
 *
 * @method createNewRow b b
  ...
  return computeLayout(
    ...
    input.map(function(item, i) {
      if (item.ImageWidth && item.ImageHeight) {
        return {
          windowHeight: getWinH(),
          aspectRatio: item.ImageWidth / item.ImageHeight,
          FileName: item.FileName,
          ShutterSpeedValue: item.ShutterSpeedValue,
          ApertureValue: item.ApertureValue,
          FocalLength: item.FocalLength,
          Creator: item.Creator,
          Subject: item.Subject,
          id: i,
          FileTypeExtension: item.FileTypeExtension
        };
      } else {
